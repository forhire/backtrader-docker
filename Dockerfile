...
RUN cp /tmp/backtrader/backtrader/plot/locator.py /opt/conda/lib/python3.7/site-packages/backtrader/plot/locator.py && rm -fR /tmp/backtrader && /opt/conda/bin/pip install backtrader_plotting
